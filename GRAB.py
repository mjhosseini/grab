...
def BCD(S, maxIter=20, lmbda=.15, k_in=5, tol=1e-4,o_size=.25):
    ...
    for i in range(maxIter):
        ...
        (W,z) = zstep(S, W, Theta, P, K, C, lmbda, Max)
        ...
        nnz = (np.count_nonzero(Theta) - P) / 2
...
def zstep(S, W, Theta, P, K, C, lmbda, Max, etha=.1):
    coef = 1
    ...
    beta2 = K
    (W,z) = solve_z(Theta,P,1.0,beta2,tau,None)
